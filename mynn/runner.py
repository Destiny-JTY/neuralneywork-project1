...
class RunnerM():
    ...
    def train(self, train_set, dev_set, **kwargs):
        ...
        checkpoint_interval = kwargs.get("checkpoint_interval", None)
        ...
        for epoch in range(num_epochs):
            ...
            for iteration, start in enumerate(range(0, X.shape[0], self.batch_size)):
                ...
                if checkpoint_dir is not None and checkpoint_interval is not None and global_step % checkpoint_interval == 0:
                    save_path = os.path.join(checkpoint_dir, f'checkpoint_step_{global_step}.pickle')
