...
class Model_CNN(Layer):
    ...
    """
    def __init__(self, img_shape=(1, 28, 28), num_classes=10, lambda_list=None):
    ...
    def _build_layers(self):
        ...
        self.layers = [conv1, ReLU(), conv2, ReLU(), fc]
    ...
    def save_model(self, save_path):
        ...
        with open(save_path, 'wb') as f:
            pickle.dump({'img_shape': self.img_shape, 'num_classes': self.num_classes, 'params': params}, f)
